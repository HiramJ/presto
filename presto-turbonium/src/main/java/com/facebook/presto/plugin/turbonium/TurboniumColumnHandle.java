...
public final class TurboniumColumnHandle
        implements ColumnHandle
{
    ...
    public TurboniumColumnHandle(ColumnMetadata columnMetadata, int columnIndex)
    {
        this(columnMetadata.getName(), columnMetadata.getType(), columnIndex);
    }

    @JsonCreator
    public TurboniumColumnHandle(
    ...
    public boolean equals(Object obj)
    {
        ...
        TurboniumColumnHandle other = (TurboniumColumnHandle) obj;
